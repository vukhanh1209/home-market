        ...
        <Fragment>
            ...
            <footer class="bg-white ">
                <div class="mx-auto w-full container">
                    <div class="flex gap-x-40 p-10">
                        <div class="mb-6 md:mb-0 max-w-[200px] ">
                            <a href="https://flowbite.com/" class="flex items-center mb-6">
                                {/* <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" /> */}
                                <span class="self-center text-2xl font-semibold whitespace-nowrap text-[#80B82D] ">HomeMarket</span>
