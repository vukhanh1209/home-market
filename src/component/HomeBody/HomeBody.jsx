...
const HomeBody = () => {
    const [favouriteProduct, setFavouriteProduct] = useState('newProduct');
    return (
        <>
            <div className=" px-36 py-16">
                ...
                <div className="grid grid-cols-4 bg-white drop-shadow-[0_0_20px_rgba(0,0,0,0.1)] py-6 mb-12">
                    ...
                    <div className="flex justify-center items-center flex-col">
                        <svg className="w-20 h-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8.24999 18L5.24999 20.25V15.75H2.25C1.85217 15.75 1.47064 15.5919 1.18934 15.3106C0.908034 15.0293 0.749999 14.6478 0.749999 14.25V2.25C0.749999 1.85217 0.908034 1.47064 1.18934 1.18934C1.47064 0.908034 1.85217 0.749999 2.25 0.749999H18.75C19.1478 0.749999 19.5293 0.908034 19.8106 1.18934C20.0919 1.47064 20.25 1.85217 20.25 2.25V6.71484" stroke="#383634" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M5.24999 5.24999H15.75" stroke="#383634" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M5.24999 9.74999H8.24999" stroke="#383634" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M23.25 18.75H20.25V23.25L15.75 18.75H11.25V9.74999H23.25V18.75Z" stroke="#383634" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M19.5 15H15" stroke="#383634" strokeWidth="0.9600000000000002" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>    
                ...
                <div className="flex flex-col items-center gap-y-6 mb-12">
                    ...
                    <div className="flex gap-x-5 font-bold">
                        <span 
                            onClick={() => setFavouriteProduct('newProduct')} 
                            className={`${favouriteProduct == "newProduct" ? 'cursor-default bg-green--dark text-white' : 'border-2 border-green text-green--dark cursor-pointer  hover:-translate-y-1 hover:shadow-md'} px-4 py-2 rounded-lg hover:bg-green--dark hover:text-white transition-all`}>
                            Sản phẩm mới
                        </span>
                        <span 
                            onClick={() => setFavouriteProduct('bestSeller')} 
                            className={`${favouriteProduct == "bestSeller" ? 'cursor-default bg-green--dark text-white' : 'border-2 border-green text-green--dark cursor-pointer  hover:-translate-y-1 hover:shadow-md'} px-4 py-2 rounded-lg hover:bg-green--dark hover:text-white transition-all`}>
                            Bán chạy
                        </span>
                        <span 
                            onClick={() => setFavouriteProduct('highRating')} 
                            className={`${favouriteProduct == "highRating" ? 'cursor-default bg-green--dark text-white' : 'border-2 border-green text-green--dark cursor-pointer  hover:-translate-y-1 hover:shadow-md'} px-4 py-2 rounded-lg hover:bg-green--dark hover:text-white transition-all`}>
                            Đánh giá cao
                        </span>
                    </div>
                    <Swiper
                ...
                <div className="grid grid-cols-2 gap-32 w-full h-[500px]">
                    <div className="flex flex-col gap-y-6 items-start max-w-max">
                        ...
                        <div className="flex flex-col gap-y-6">
                            ...
                            <div className="flex justify-center items-center gap-x-4"> 
                                <div className="p-4 bg-gray-50 rounded-md "> 
                                    <svg className="w-10 h-10 " viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#4C7C7D" strokeWidth="1.6799999999999997"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="9" stroke="#4C7C7D"></circle> <path d="M18 18L6 6" stroke="#4C7C7D"></path> </g></svg>
                                </div>
                                <div className="whitespace-normal">
